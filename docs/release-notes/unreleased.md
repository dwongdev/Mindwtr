...
- feat: reopening the app within 10 minutes now resumes on the screen you left — including the project you had open — so an interruption (Android reclaiming memory, an app restart) no longer dumps you back at the start; after a longer break the app still opens fresh on its home view. (#842)
