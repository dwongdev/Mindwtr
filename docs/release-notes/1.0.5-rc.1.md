...
- Verify the RC blocker fixes: Inbox Processing `Later` + `No date`, Focus default grouping, capture default-area picker, and docs-link routing.
- Check release automation recovery paths: Docker duplicate-tag skips, stable-only MCP publishing, and manual RC redispatch after retagging.
