...
- Sync is safer and more visible with delete-vs-edit discard diagnostics, capped pending-write retries, stale tombstone repair, batched SQLite pruning, bounded notification rescheduling, and stronger cloud auth rate limiting.
