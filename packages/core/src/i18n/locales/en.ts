...
export const en: Record<string, string> = {
        ...
        'settings.syncFailureAuth': 'Re-authenticate or review your sync credentials in Data & Sync.',
        'settings.syncFailurePermission': 'Re-select the sync file or folder, or grant access again in Data & Sync.',
        'settings.syncFailureRateLimited': 'The sync backend is rate limiting requests. Wait a moment and try again.',
        'settings.syncFailureMisconfigured': 'Finish configuring the selected sync backend in Data & Sync.',
        'settings.syncFailureConflict': 'Another device or backend reported a sync conflict. Retry after both sides finish syncing.',
        'settings.syncFailureGeneric': 'Review Data & Sync settings and try again.',
