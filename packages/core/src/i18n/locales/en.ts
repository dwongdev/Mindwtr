...
export const en: Record<string, string> = {
    ...
    'sandbox.confirmTitle': "Enter sandbox?",
    'sandbox.confirmDescription': "Use fictional tasks and projects to record a bug or give a demo. Your personal data stays separate. Sandbox changes are discarded when you exit.",
    'sandbox.enter': "Enter sandbox",
    'sandbox.title': "Sandbox · Sample data",
    'sandbox.exit': "Exit sandbox",
    'sandbox.reset': "Reset sample data",
    'sandbox.description': "Try Mindwtr with fictional tasks and projects. Your personal data stays separate.",
    'sandbox.notice': "Changes here are temporary. Sync and external integrations are unavailable.",
    'sandbox.unavailable': "Unavailable in sandbox",
    'sandbox.switching': "Switching workspace…",
    'sandbox.switchFailed': "Could not switch workspaces. Your current workspace is unchanged.",
        ...
        'timeline.emptyHint': 'Projects and tasks with a start or due date appear here as bars.',
        'timeline.omittedItems': '{{count}} more',
        ...
        'quickAdd.pastedImageError': 'Could not attach pasted image.',
        'quickAdd.pastedImageAttached': '1 image attached',
        'quickAdd.pastedImagesAttached': '{{count}} images attached',
        ...
        'keybindings.goTrash': 'Go to Trash',
        ...
        'task.convertToSectionCreated': 'Section created from task',
        'task.convertToSectionFailed': 'Failed to convert task to a section',
        ...
        'search.cancelledDate': 'Cancelled {{date}}',
        ...
        'archive.filtersClearedForTask': 'Cleared the archive filters so the selected task is visible.',
        'archive.loadFailed': 'Failed to load archived tasks',
        ...
        'inbox.nextTask': 'Next task →',
        'inbox.tapNextHint': 'Tap "Next task" at the bottom to apply your choices and move on.',
        ...
        'calendar.showScheduledHint': 'Show tasks on their start date; turn off to read only deadlines',
  ...
  'projects.reorderNeedsDefaultSort': 'Available when Sort is Default',
        ...
        'projects.archiveHelp': 'Completing a project finishes its remaining tasks and moves it to Completed — reactivate it anytime.',
        ...
        'projects.nextActionPromptFailed': 'Could not update the next action.',
        'projects.projectTypeLabel': 'Type',
        'projects.areaInUse': 'Area has projects.',
        'projects.manageAreas': 'Manage areas',
        'projects.editArea': 'Edit area',
        'projects.renameArea': 'Rename area',
        'projects.changeColor': 'Choose color',
        'projects.moveSectionUp': 'Move section up',
        'projects.moveSectionDown': 'Move section down',
        'projects.moveSectionLeft': 'Move section left',
        'projects.moveSectionRight': 'Move section right',
        'projects.layoutColumns': 'Columns',
        'projects.projectOrder': 'Project order',
        'projects.sectionReorderFailed': 'Failed to reorder sections.',
        ...
        'review.collapseEverything': 'Collapse all',
        ...
        'process.later': 'Start later',
        'process.laterHint': 'Set a start date and move this to Next Actions.',
        'process.laterStartRequired': 'Choose a start date for Start later.',
        'process.incubate': 'Incubate',
        'process.incubateHint': 'Park this without deciding. It comes back to clarify on the date you choose.',
        'process.incubateDateRequired': 'Choose a date to bring this back.',
        'process.returningItem': 'Back to clarify',
        'process.returningItemHint': 'You incubated this. Decide what it is now.',
    ...
    'settings.timeFormat': 'Time format',
        ...
        'settings.syncEncryption': 'Encryption',
        'settings.syncEncryptionDesc': 'Encrypt the synced files with a passphrase. Devices without the passphrase cannot read them.',
        'settings.syncEncryptionEnable': 'Enable encryption',
        'settings.syncEncryptionPassphrase': 'Passphrase',
        'settings.syncEncryptionPassphraseConfirm': 'Confirm passphrase',
        'settings.syncEncryptionCurrentPassphrase': 'Current passphrase',
        'settings.syncEncryptionNewPassphrase': 'New passphrase',
        'settings.syncEncryptionShowPassphrase': 'Show passphrase',
        'settings.syncEncryptionGenerate': 'Generate a passphrase',
        'settings.syncEncryptionGeneratedHint': 'Write this passphrase down or save it in a password manager before you continue.',
        'settings.syncEncryptionWarningLost': 'The passphrase cannot be recovered. If you lose it, the synced copies can never be read again. The data on this device stays readable.',
        ...
        'settings.syncEncryptionStatusOn': 'Sync encryption is on',
        'settings.syncEncryptionChange': 'Change passphrase',
        'settings.syncEncryptionDisable': 'Turn off encryption',
        'settings.syncEncryptionDisableWarning': 'The synced files go back to plain text at the sync location. Data on your devices is unaffected.',
        'settings.syncEncryptionDisableWarningNoBackend': 'Sync is not set up, so no synced files change — this only removes the passphrase and key from this device. A sync location that was encrypted earlier stays encrypted and still needs the passphrase.',
        'settings.syncEncryptionLockedTitle': 'This sync location is encrypted',
        'settings.syncEncryptionLockedDesc': 'Enter its passphrase to read the synced files on this device.',
  ...
  'settings.syncPreferenceGtd': 'GTD settings and defaults',
        ...
        'settings.externalSyncChangeTitle': 'External sync change detected',
        'settings.externalSyncChangeBody': 'The sync file changed while local edits were pending. Choose how to continue.',
        'settings.useExternal': 'Use external',
        'settings.mergeChanges': 'Merge',
        ...
        'settings.emailCaptureFailed': 'Email capture',
        ...
        'settings.syncFailureEncryption': 'This sync location is encrypted. Enter its passphrase in Settings → Sync to continue.',
        ...
        'settings.calendarFeed': 'Calendar subscription',
        'settings.calendarFeedDesc': 'Publish a read-only feed of your scheduled tasks and deadlines that any calendar app can subscribe to.',
        'settings.calendarFeedWarning': 'Anyone with this URL can read the feed. Regenerate it to invalidate the old one.',
        'settings.calendarFeedNone': 'No feed published yet.',
        'settings.calendarFeedCopy': 'Copy URL',
        'settings.calendarFeedGenerate': 'Generate URL',
        'settings.calendarFeedRegenerate': 'Regenerate',
        'settings.calendarFeedRevoke': 'Revoke',
        ...
        'settings.importMindwtrCsvSummary': 'Imported {{taskCount}} task(s), {{projectCount}} project(s), {{sectionCount}} section(s), and {{areaCount}} area(s).',
        ...
        'settings.featureTimelineDesc': 'Show a read-only timeline of dated projects and tasks in the sidebar.',
        'settings.sidebarViews': 'Sidebar views',
        'settings.sidebarViewsDesc': 'Choose which views appear in the sidebar. Hidden views stay reachable with their go-to keyboard shortcut, and you can show them again here.',
        ...
        'pomodoro.noTask': 'No available focus task',
        'pomodoro.selectedTask': 'Timer task',
        'pomodoro.timerOnly': 'Timer only',
        'pomodoro.linkTask': 'Link task',
        'pomodoro.markTaskDone': 'Mark task done',
        'pomodoro.taskDoneShort': 'Task done',
        'pomodoro.sessionsDone': 'Focus sessions completed',
        'pomodoro.focusComplete': 'Focus session complete. Take a short break.',
        'pomodoro.breakComplete': 'Break complete. Ready for the next focus session.',
        ...
        'bulk.organizeHint': 'Apply shared organizing fields. Titles and descriptions stay unchanged.',
        ...
        'bulk.deleteFailed': 'Failed to delete selected tasks',
        'bulk.organizeFailed': 'Failed to organize selected tasks',
        'bulk.moveFailed': 'Failed to move selected tasks',
        'bulk.updateFailed': 'Failed to update selected tasks',
        ...
        'projects.duplicateFailed': 'Failed to duplicate project',
        ...
        'search.areaFilterFailed': 'Failed to update area filter.',
        'search.switchedToAllAreas': 'Switched to All Areas so the selected item is visible.',
        ...
        'settings.testFolder': 'Test folder',
        'settings.testingFolder': 'Testing folder…',
        'settings.folderTestSucceeded': 'Folder test passed.',
        'settings.portalPathNote': 'This path is a sandbox mapping to the folder you chose. External tools such as Syncthing should watch the original folder, not this path.',
        ...
        'settings.undoImport': 'Undo',
        'settings.undoImportConfirmTitle': 'Undo this change?',
        'settings.undoImportConfirm': 'Restore the snapshot taken just before this change ({{snapshotName}})? Anything you changed since is rolled back too.',
        ...
        'settings.feedback.saveFailed': "Couldn't save this setting. Try again.",
        'settings.feedback.loadFailed': "Couldn't load this setting. Try again.",
        'settings.feedback.actionFailed': "Couldn't complete this action. Try again.",
        'settings.calendar.invalidSource': 'Use an http(s), webcal, or absolute file:///path.ics source.',
        'settings.calendar.localIcsDesktopRequired': 'Local ICS files require the desktop app.',
        'settings.calendar.writableTargetUnavailable': 'Could not create or find a writable system calendar target.',
        'settings.sync.validHttpUrl': 'Enter a valid http(s) URL.',
        'settings.sync.invalidToken': 'Sync token must be 20-512 characters using letters, numbers, or . _ ~ + / = -',
        'settings.sync.folderRequired': 'Select a folder for sync, not a backup JSON file.',
        'settings.sync.folderPermissionDenied': 'Mindwtr cannot access this folder. Choose a folder you own, then try again.',
        'settings.sync.dropboxCredentialCleanupFailed': 'Pending Dropbox authorization could not be safely cleared. Try again.',
        'settings.sync.dropboxDisconnected': 'Disconnected from Dropbox.',
        'settings.sync.calendarFeedGenerated': 'Calendar feed URL generated.',
        'settings.sync.calendarFeedRevoked': 'Calendar feed revoked.',
        'settings.sync.calendarFeedCopied': 'Subscription URL copied.',
        'settings.sync.calendarFeedCopyFailed': 'Could not copy the subscription URL.',
        ...
        'settings.backupMobile.importMindwtrCsvData': 'Import Mindwtr CSV data?',
        ...
        'settings.backupMobile.importedTaskProjectSectionAreaCounts': 'Imported {{taskCount}} task(s), {{projectCount}} project(s), {{sectionCount}} section(s), and {{areaCount}} area(s).',
        ...
        'settings.backupMobile.theSelectedFileIsNotASupportedMindwtrCsvFile': 'The selected file is not a supported Mindwtr CSV file.',
        ...
        'settings.backupMobile.mindwtrCsvAreasWillBeCreated': '{{areaCount}} area(s) will be created from the Area column.',
        'settings.backupMobile.mindwtrCsvSectionsWillBeCreated': '{{sectionCount}} section(s) will be created from the Section column.',
        ...
        'settings.calendarMobile.mindwtrCalendarColor': 'Mindwtr calendar color',
        'settings.calendarMobile.mindwtrCalendarColorDesc': 'Applies to the Mindwtr-created calendar; shared account calendars keep their own color.',
        ...
        'settings.syncMobile.importFromMindwtrCsv': 'Import from Mindwtr CSV',
        ...
        'settings.syncMobile.importMindwtrCsvFileIntoMindwtrAreasProjectsAndTasks': 'Import a generic Mindwtr CSV file into Mindwtr areas, projects, sections, and tasks.',
        ...
        'settings.syncMobile.iosFolderFallbackTitle': 'Folder not selectable?',
        'settings.syncMobile.iosFolderFallbackMessage': 'Some storage apps (Google Drive, OneDrive, ownCloud…) do not allow folder selection on iOS. You can pick a Mindwtr backup JSON file stored in that app instead: first save one there with "Export Backup", then select that file in the next screen. Mindwtr will sync through it.',
        'settings.syncMobile.iosFolderFallbackConfirm': 'Select backup file',
    ...
    'obsidian.bringIntoMindwtrFailed': 'Could not add the task to Mindwtr.',
        ...
        'onboarding.startFreshTitle': "Start using Mindwtr",
        'onboarding.help': "Help",
        'onboarding.captureAction': "Capture to Inbox",
        'onboarding.tryWorkflow': "Capture a thought, clarify it in Inbox, then choose what to do in Focus.",
        'onboarding.readGuide': "Read the guide",
        'onboarding.guideError': "Could not open the guide. Tap the link to try again.",
        'onboarding.focusHint': "Next Actions are available to do. Use the star to choose a few for Today’s Focus. Defer an action to hide it until later; find it again in Calendar or search.",
        'onboarding.schedulingHint': "Start is when an action becomes available. Due is a real deadline. Leave dates empty when neither applies.",
        'onboarding.detailsHint': "Extra fields are optional. Capture a thought first, then add only what helps you act. Change visible fields in Settings → GTD → Task Editor Layout.",
        ...
        'settings.backupDesc': 'Export a full backup, or restore or merge local data from a backup file.',
        'settings.importDataDesc': 'Import Todoist, TickTick, DGT GTD, OmniFocus, and Mindwtr CSV exports.',
        'settings.exportBackupDesc': 'Save the current local data as a JSON backup file.',
        'settings.exportCsv': 'Export CSV',
        'settings.exportCsvDesc': 'Save your live tasks as a Mindwtr CSV file you can edit in a spreadsheet and import back.',
        'settings.exportCsvSuccess': 'CSV exported successfully!',
        'settings.exportCsvFailed': 'Failed to export CSV',
        'settings.exportTaskNotes': 'Export as TaskNotes',
        'settings.exportTaskNotesDesc': 'Save your live tasks as Markdown files for Obsidian’s TaskNotes plugin — one file per task, packed as a ZIP.',
        'settings.exportTaskNotesSuccess': 'TaskNotes files exported successfully!',
        'settings.exportTaskNotesFailed': 'Failed to export TaskNotes files',
        'settings.restoreBackup': 'Restore Backup',
        'settings.restoreBackupDesc': 'Replace local data from a Mindwtr backup JSON file.',
        'settings.mergeBackup': 'Merge Backup',
        'settings.mergeBackupDesc': 'Combine a Mindwtr backup JSON file with local data, keeping whichever copy of each item is newer.',
        'settings.mergeBackupConfirm': 'Newer items from the backup are combined with your current data. Nothing local is removed, and items you deleted here stay deleted. A recovery snapshot is saved first when available.',
        'settings.mergeBackupAction': 'Merge',
        'settings.mergeBackupSummary': '{{addedCount}} task(s) added, {{updatedCount}} updated.',
        'settings.mergeBackupFailed': 'Merge failed',
        ...
        'settings.importMindwtrCsv': 'Import from Mindwtr CSV',
        'settings.importMindwtrCsvDesc': 'Import a generic Mindwtr CSV file into Mindwtr areas, projects, sections, and tasks.',
        ...
        'settings.gettingStartedContentAction': 'Add Getting Started content',
        'settings.gettingStartedContentDesc': 'Create or restore the guided setup project and sample inbox items.',
        'settings.gettingStartedContentConfirmTitle': 'Add Getting Started content?',
        'settings.gettingStartedContentConfirmDesc': 'This adds a guided Getting Started project and sample inbox items to your current data. Existing Getting Started content will not be duplicated.',
        'settings.gettingStartedContentConfirm': 'Add content',
        'settings.gettingStartedContentContinueTitle': 'Continue setup',
        ...
        'shareCard.tagline': "Mind like water.",
        'shareCard.privacy': "Your tasks and projects stay private. The card uses the date and the reflection you write.",
        ...
        'shareCard.reviewBody': "This week, I made space to think.",
        'shareCard.qrLabel': "Get Mindwtr",
};
