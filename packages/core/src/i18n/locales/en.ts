...
export const en: Record<string, string> = {
        ...
        'settings.analyticsHeartbeatDesc': 'Small diagnostic signal for app health and platform/version adoption. No task or personal data is included.',
        'settings.analyticsHeartbeatDisableTitle': 'Disable anonymous heartbeat?',
        'settings.analyticsHeartbeatDisableDesc': 'Heartbeats never include user data or personal info. They only send anonymous diagnostics to help developers understand app health and versions.',
