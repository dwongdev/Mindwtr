...
export const en: Record<string, string> = {
        ...
        'calendar.mobile.showValueVisibleDays': 'Show {{value1}} visible days',
        ...
        'calendar.mobile.valueDays': '{{value1}} days',
        ...
        'settings.aiMobile.offlineModelPathIsAFolderValuePleaseRemoveIt': 'Offline model path is a folder ({{value1}}). Please remove it and try again.',
        'settings.aiMobile.offlineModelPathIsNotSafeToModifyValue': 'Offline model path is not safe to modify ({{value1}}).',
        ...
        'settings.aiMobile.toUseAiAssistantYourTaskTextAndOptionalNotes2': 'To use AI assistant, your task text and optional notes will be sent directly to {{value1}} using your API key. Mindwtr does not collect this data. Provider privacy policy: {{value2}}. Do you want to continue?',
        ...
        'settings.aiMobile.whenEnabledTaskTextIsSentDirectlyToValueUsing': 'When enabled, task text is sent directly to {{value1}} using your API key.',
        ...
        'settings.backupMobile.backupDateValue': 'Backup date: {{value1}}',
        'settings.backupMobile.backupRestoredSuccessfullyRecoverySnapshotSavedAsValue': 'Backup restored successfully. Recovery snapshot saved as {{value1}}.',
        'settings.backupMobile.containsValueTasksAndValueProjects': 'Contains {{value1}} tasks and {{value2}} projects.',
        'settings.backupMobile.failedToExportBackup': 'Failed to export backup',
        'settings.backupMobile.fileValue': 'File: {{value1}}',
        ...
        'settings.backupMobile.importedValueTaskSAndValueProjectS': 'Imported {{value1}} task(s) and {{value2}} project(s).',
        'settings.backupMobile.importedValueTasksIntoValueProjectS': 'Imported {{value1}} tasks into {{value2}} project(s).',
        'settings.backupMobile.importedValueTaskSValueProjectSAndValueArea': 'Imported {{value1}} task(s), {{value2}} project(s), and {{value3}} area(s).',
        ...
        'settings.backupMobile.importValueTasksFromValue': 'Import {{value1}} tasks from {{value2}}?',
        'settings.backupMobile.importValueTaskSFromValue': 'Import {{value1}} task(s) from {{value2}}?',
        'settings.backupMobile.importValueTasksFromValueTodoistProjectS': 'Import {{value1}} tasks from {{value2}} Todoist project(s)?',
        ...
        'settings.backupMobile.recoverySnapshotSavedAsValue': 'Recovery snapshot saved as {{value1}}.',
        ...
        'settings.backupMobile.restoreValueThisWillReplaceCurrentLocalData': 'Restore {{value1}}? This will replace current local data.',
        ...
        'settings.backupMobile.valueAreaSWereCreatedFromOmnifocusFolders': '{{value1}} area(s) were created from OmniFocus folders.',
        'settings.backupMobile.valueAreaSWillBeCreatedFromDgtFolders': '{{value1}} area(s) will be created from DGT folders.',
        'settings.backupMobile.valueAreaSWillBeCreatedFromOmnifocusFoldersWhen': '{{value1}} area(s) will be created from OmniFocus folders when needed.',
        'settings.backupMobile.valueChecklistItemSWerePreserved': '{{value1}} checklist item(s) were preserved.',
        'settings.backupMobile.valueChecklistItemSWillBePreserved': '{{value1}} checklist item(s) will be preserved.',
        'settings.backupMobile.valueMoreProjectS': '• {{value1}} more project(s)…',
        'settings.backupMobile.valueNestedTaskSBecameChecklistItems': '{{value1}} nested task(s) became checklist items.',
        'settings.backupMobile.valueNestedTaskSWillBecomeChecklistItemsWhenPossible': '{{value1}} nested task(s) will become checklist items when possible.',
        'settings.backupMobile.valueProjectSWillBeCreated': '{{value1}} project(s) will be created.',
        'settings.backupMobile.valueProjectSWillBeCreatedWhenNeeded': '{{value1}} project(s) will be created when needed.',
        'settings.backupMobile.valueSectionSWillBePreserved': '{{value1}} section(s) will be preserved.',
        'settings.backupMobile.valueSubtaskSBecameChecklistItems': '{{value1}} subtask(s) became checklist items.',
        'settings.backupMobile.valueSubtaskSWillBecomeChecklistItems': '{{value1}} subtask(s) will become checklist items.',
        'settings.backupMobile.valueTaskSStayedOutsideProjects': '{{value1}} task(s) stayed outside projects.',
        'settings.backupMobile.valueTaskSWillStayOutsideProjectsSoYouCan': '{{value1}} task(s) will stay outside projects so you can process them in Mindwtr.',
