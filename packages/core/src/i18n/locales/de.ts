...
export const deOverrides: Record<string, string> = {
        ...
        'settings.analyticsHeartbeatDesc': 'Kleines Diagnosesignal für App-Zustand und Plattform-/Versionsnutzung. Es enthält keine Aufgaben oder personenbezogenen Daten.',
        'settings.analyticsHeartbeatDisableTitle': 'Anonymen Heartbeat deaktivieren?',
        'settings.analyticsHeartbeatDisableDesc': 'Heartbeats enthalten nie Nutzerdaten oder persönliche Infos. Sie senden nur anonyme Diagnosedaten, damit Entwickler App-Zustand und Versionen verstehen.',
