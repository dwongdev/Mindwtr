            ...
            <section className="space-y-3">
                ...
                <div className="bg-card border border-border rounded-lg p-6 space-y-3">
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            <div>
                                <div className="text-sm font-medium text-foreground">{t.importDgt}</div>
                                <div className="text-xs text-muted-foreground">{t.importDgtDesc}</div>
                            </div>
                            <div className="text-xs text-muted-foreground">
                                {transferAction === 'import' ? t.syncing : null}
                            </div>
                        ...
                        >
                            <div>
                                <div className="text-sm font-medium text-foreground">{t.importOmniFocus}</div>
                                <div className="text-xs text-muted-foreground">{t.importOmniFocusDesc}</div>
                            </div>
                            <div className="text-xs text-muted-foreground">
                                {transferAction === 'import' ? t.syncing : null}
                            </div>
