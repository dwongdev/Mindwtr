export const labelFallback = {
    en: {
        ...
        pathHint: 'Choose a folder (e.g., ~/Sync/mindwtr). Backup JSON files are for import/export, not sync paths.',
    ...
    zh: {
        ...
        syncing: '同步中…',
        syncQueued: '同步已排队',
        pathHint: '请选择文件夹（如 ~/Sync/mindwtr）。备份 JSON 文件用于导入/导出，不是同步路径。',
        webdavUrl: 'WebDAV 地址',
        webdavUsername: '用户名',
        webdavPassword: '密码',
