export const labelFallback = {
    en: {
        ...
        dataTransferDesc: 'Export a full backup, restore local data from backup, or import Todoist and DGT GTD exports.',
        ...
        syncPreferenceAppearance: 'Appearance (theme, density, text size)',
    ...
    zh: {
        ...
        aiBaseUrlHint: '官方 OpenAI 请留空。若使用本地或第三方 OpenAI 兼容接口，例如 Ollama、LM Studio、GLM 或 vLLM，请在这里填写。',
        ...
        manage: '管理',
        dataTransfer: '数据传输',
        dataTransferDesc: '导出完整备份、从备份恢复本地数据，或导入 Todoist 与 DGT GTD 导出文件。',
        exportBackup: '导出备份',
        ...
        syncPreferenceAppearance: '外观（主题、密度、文字大小）',
